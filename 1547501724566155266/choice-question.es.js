...
const Widget = ({ options }) => {
  ...
  const processText = React.useCallback((text) => {
    const array = text == null ? void 0 : text.split("\n");
    return array == null ? void 0 : array.map((item, index) => {
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", null, item), index !== array.length - 1 && /* @__PURE__ */ React.createElement("br", null));
    });
  }, []);
  React.useEffect(() => {
    if (!onChange) {
