const Question = "_Question_bxz6o_1";
const Input = "_Input_bxz6o_11";
const OptionList = "_OptionList_bxz6o_23";
const Item = "_Item_bxz6o_23";
const Selected = "_Selected_bxz6o_33";
const Action = "_Action_bxz6o_39";
const Button = "_Button_bxz6o_48";
var styles = {
  "Question-Box": "_Question-Box_bxz6o_1",
  Question,
  Input,
  OptionList,
  Item,
